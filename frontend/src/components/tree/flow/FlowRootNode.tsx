...
export function FlowRootNode({ data }: RootNodeProps) {
  ...
  return (
    ...
    >
      ...
      {wage && (
        <span className="mt-0.5 font-mono text-[10px] text-[#8A8595]">{wage}</span>
      )}
      <Handle
        type="source"
        position={sourceSide}
