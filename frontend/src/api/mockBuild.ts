...
export async function mockCreateBuild(
  ...
  const gauntlet: GauntletResult = {
    fights: [
      { boss: "ai", label: "Fight AI", result: "win", raw_score: 6, threshold_win: 5, threshold_draw: 3, reason: "Strong human-skill mix keeps this career relevant.", narrative: "Your creativity gives you an edge machines can't match.", rerolled: false, reroll_count: 0, original_result: null, original_raw_score: null },
      { boss: "loans", label: "Student Loans", result: "win", raw_score: 7, threshold_win: 5, threshold_draw: 3, reason: "High earnings relative to debt load.", narrative: "Your earning power outpaces your debt comfortably.", rerolled: false, reroll_count: 0, original_result: null, original_raw_score: null },
      { boss: "market", label: "The Market", result: "win", raw_score: 8, threshold_win: 5, threshold_draw: 3, reason: "This field is growing much faster than average.", narrative: "The market is hungry for people like you.", rerolled: false, reroll_count: 0, original_result: null, original_raw_score: null },
      { boss: "burnout", label: "Burnout", result: "draw", raw_score: 4, threshold_win: 5, threshold_draw: 3, reason: "Moderate stress factors — manageable but present.", narrative: "Burnout is real in this field, but awareness is your armor.", rerolled: false, reroll_count: 0, original_result: null, original_raw_score: null },
      { boss: "ceiling", label: "The Ceiling", result: "win", raw_score: 7, threshold_win: 5, threshold_draw: 3, reason: "Strong upward mobility with management paths available.", narrative: "The ceiling is high — your growth potential is real.", rerolled: false, reroll_count: 0, original_result: null, original_raw_score: null },
    ],
    wins: 4,
    losses: 0,
    draws: 1,
