"""FutureProof archived interactive CLI spike.

Deprecated: this proof of concept was moved out of ``backend/`` after the
web/API implementation became canonical. It may contain stale prompts and
should not be used for the Kaggle demo, judge instructions, or current
product verification.

If you need to inspect it historically, run from the project root with:
``uv run python archive/spikes/cli/cli.py``.
"""
