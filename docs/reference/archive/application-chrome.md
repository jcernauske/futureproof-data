...
> **This is the original chrome design proposal.** The authoritative Application Header spec now lives in **`DESIGN.md`** at the project root. Where this document and DESIGN.md conflict, DESIGN.md wins.

**Author:** @fp-design-visionary
**Date:** 2026-04-12
**Status:** Archived — absorbed into DESIGN.md
