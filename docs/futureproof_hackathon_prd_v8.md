...
|---|---|---|---|---|---|
| F1 | `screen-landing-profile` | 1, 2 | Landing hero (tagline, pentagon glow, CTA) + profile name generation (auto-assign, reroll button, returning user lookup). First thing the student sees. | ⬜ Not started | B1, B2 |
