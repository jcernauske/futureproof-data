...
This document is the north star for every frontend spec, every mockup, and every implementation decision in FutureProof. It describes how the product should *feel* as a complete experience — the emotional arc from first landing to Instagram share, the transitions between screens, the three moments that win the hackathon, and the specific design system gaps that must be closed before implementation begins.

Every screen spec should trace back to something in this report. If a design decision contradicts this report, this report wins unless the human overrides it.
...
*This report is the north star. Every screen spec, every mockup, and every implementation decision should trace back to something written here. If a design decision contradicts this report, this report wins unless the human overrides it.*
