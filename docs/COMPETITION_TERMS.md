By clicking on the "I Understand and Accept" button below, you agree to be bound by the competition rules for [The Gemma 4 Good Hackathon](https://www.kaggle.com/competitions/gemma-4-good-hackathon/rules).

COMPETITION-SPECIFIC RULES

## ENTRY IN THIS COMPETITION CONSTITUTES YOUR ACCEPTANCE OF THESE OFFICIAL COMPETITION RULES.

**[See Section 3.18 for defined terms](https://www.kaggle.com/competitions/rules#18.-terms)**
...
1. None. Competition Data will not be provided by Competition Sponsor for this Competition.
...
1. **Open Source:** You hereby license and will license your winning Submission and the source code used to generate the Submission under [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.en), an Open Source Initiative-approved license (see [www.opensource.org](http://www.opensource.org)) that in no event limits commercial use of such code or model containing or depending on such code. 
...
I agree to the Competition-specific rules above and Kaggle’s Foundational Competition Rules. The Kaggle Competition Foundational Rules supersede  the Competition-specific rules in the event of any conflict.

I understand joining this Competition creates a direct relationship  between the Host and me. Kaggle has no liability for any promised  prizes, commitments, content, or actions of a Host or Participant.

When the hackathon closes, your writeup will be licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.en), and  be publicly available on Kaggle, attributed to your current Kaggle  display name. If you need to update this attribution later, reach out to support@kaggle.com.