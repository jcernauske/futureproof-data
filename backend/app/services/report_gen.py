...
just the data and Gemma's analysis.
"""
...
def generate_build_report(
    ...
    *,
    ...
    lines.append(
        "- Gemma's Take and skill recommendations are AI-generated "
...
def generate_comparison_report(
    ...
    lines.append(
        ...
        "This comparison is generated by FutureProof (Gemma 4) and "
        "should complement, not replace, professional guidance.*"
    )
    lines.append("")
