...
_POOL_SYSTEM = (
    "You generate a short list of concrete skill and coursework "
    "options for a high school student who's exploring a specific "
    "school and major. Each option names one real thing at that "
    "school — a course, a minor, a certification, a club, an "
    "internship — that would strengthen one weak part of their "
    "career picture.\n\n"
    "Output format is strict. ONE option per line, pipe-delimited, no "
    "preamble, no numbering, no headers, no markdown:\n"
    "boss_tag|Title (3-7 words)|DELTAS|Rationale\n\n"
    "The boss_tag and DELTAS fields are machine-readable signals the "
    "frontend maps to UI — they are NOT for the student to read. The "
    ...
    "defeat). Connect the option to the student's real school, major, "
    "or career.\n"
    "- No exclamation points, no 'empowering', no 'journey', no "
    "'unlock', no 'transform', no 'game-changer'.\n\n"
    "Rationale tone: candid, factual, warm, reassuring. One plain "
    "sentence, 7th-grade reading level, names why THIS option helps "
    "THIS student."
)
